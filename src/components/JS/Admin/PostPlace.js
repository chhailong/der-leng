            ...
            <div class="container px-4 px-lg-5">
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-md-10 col-lg-8 col-xl-7">
                        <h2 className='text-uppercase text-danger'>post place</h2>
                    <div class="my-5">
                        <form >
                            ...
                            <div class="select mb-2">
                                <select class="form-select"  onChange={(e) =>setProvince_id(e.target.value)} name ="province_id" aria-label=" select ">
                                    ...
                                    <option value="19">Preah Sihanouk</option>
                                    <option value="4">Battambang</option>
                                    <option value="5">Kampong Chhnang</option>
                                    <option value="11"> Kratié</option>
                                    <option value="14">Preah Vihear</option>
                                    <option value="20">Stung Treng</option>
                                    <option value="13">Phnom Penh</option>
                                </select>
                            ...
                            <button class="btn btn-outline-success btn-lg px-5 m-1"  value="Save" type="button" onClick={Post}>Post</button>
                        </form>
                    </div>
                    </div>
                </div>
